...
@section('content')
<style>
    /* --- CSS UTAMA (Konsisten dengan Quotation & PO) --- */
    body {
    ...
    <tr>
        ...
        <td width="45%" class="valign-top text-right">
            ...
            <table width="100%" style="margin-top: 5px; font-size: 9pt; border-collapse: collapse;">
                <tr>
                    <td class="text-right bold" width="60%" style="padding: 2px 0;">No. SO:</td>
                    <td class="text-right" style="padding: 2px 0;">{{ $record->so_number }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="text-right bold" style="padding: 2px 0;">No. PO Cust:</td>
                    <td class="text-right" style="padding: 2px 0;">{{ $record->customer_po_number ?? '-' }}</td>
                </tr>
                @if($record->quotation)
                <tr>
                    <td class="text-right bold" style="padding: 2px 0;">Ref Quotation:</td>
                    <td class="text-right" style="padding: 2px 0;">{{ $record->quotation->quotation_number }}</td>
                </tr>
                @endif
                <tr>
...
<table class="footer-table">
    <tr>
        ...
        <td width="60%" class="valign-top">
            ...
            <ul class="notes-ul">
                <li>Mohon periksa kembali detail pesanan di atas.</li>
                <li>Jadwal pengiriman akan dikonfirmasi oleh bagian gudang.</li>
